...
namespace Game {
    ...
    public class Save : MonoBehaviour {
        ...
        public class SaveData{
            ...
            public string date;
            public string score;
            static public int CompareScore(SaveData sc1, SaveData sc2) {
                return sc2.score.CompareTo(sc1.score);
            }
        }
        ...
        private void Awake() {
            ...
            _saveDatas.Sort(SaveData.CompareScore);
        }
        ...
        private void OnCarCollision() {
            ...
            if (_saveDatas.Count < 10) {
                ...
                for (int i = 0; i < _saveDatas.Count; i++) {
                    if (Convert.ToInt32(_saveDatas[i].score) < Convert.ToInt32(newRecord.score)) {
                        _saveDatas.Add(newRecord);
                        _saveDatas.RemoveAt(_saveDatas.Count - 2);
                    }  
                }
